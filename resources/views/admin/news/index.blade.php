                            ...
                            @foreach (allLanguages() as $lang)
                                ...
                                <div class="form-group">
                                    <label for="description">{{ __('main.Description') }} ({{ $lang->name }})<span
                                            class="text-danger">*</span></label>
                                    <textarea id="description" name="description_{{ $lang->prefix }}" class="form-control" rows="5">{{ section_title('news-section') ? section_title('news-section')->translateOrDefault($lang->prefix)->description : '' }}</textarea>
