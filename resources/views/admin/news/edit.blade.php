...
@section('title', __('main.News_Edit'))
@section('content')
                            ...
                            @foreach (allLanguages() as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title"
                                        ...
                                        value="{{ $news->translateOrDefault($lang->prefix)->title }}">
                        ...
                        <div class="card-body">
                            <div class="image-group">
                                <div class="form-group">
                                    ...
                                    <img id="target" class="target cus-mw-200"
                                        src="{{ asset(path_news_image() . $news->image) }}" alt="{{ __('main.test') }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input id="image_alt" type="text" class="form-control" name="image_alt"
                                    placeholder="{{ __('main.Image_Alt') }}" value="{{ $news->image_alt }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="status">
                                    ...
                                    <option value="2" {{ $news->status == 2 ? 'selected' : '' }}>
                                        {{ __('main.Draft') }}
                                    </option>
                                </select>
