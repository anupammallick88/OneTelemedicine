                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="birthday" type="date"
                                                        ...
                                                        name="birthday" value="{{ isset($user) ? $user->dob : '' }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="degree" type="text"
                                                        ...
                                                        name="degree" value="{{ isset($user) ? $user->qualification : '' }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="address" type="text"
                                                        ...
                                                        name="address" value="{{ isset($user) ? $user->address : '' }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="city" type="text"
                                                        ...
                                                        name="city" value="{{ isset($user) ? $user->city : '' }}"
