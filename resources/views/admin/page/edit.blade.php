...
@section('title', __('main.Page_Edit'))
@section('content')
                ...
                <div class="col-6">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('page.index') }}">{{ __('main.Page_Edit') }}</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="label" name="label"
                                    ...
                                    value="{{ $page->translateOrDefault(session()->has('locale'))->label }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="{{ __('main.Title') }}" value="{{ $page->title }}">
                            ...
                            <div class="form-group">
                                <label for="description">{{ __('main.Description') }} <span class="text-danger">*</span></label>
