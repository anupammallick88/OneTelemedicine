...
@section('title', __('main.Testimonial_Edit'))
@section('content')
                ...
                <div class="col-6">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>{{ __('main.Testimonial_Edit') }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="{{ __('main.Name') }}" value="{{ $testimonial->name }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="occupation" name="occupation"
                                    placeholder="{{ __('main.Occupation') }}" value="{{ $testimonial->occupation }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="{{ __('main.Title') }}" value="{{ $testimonial->title }}">
