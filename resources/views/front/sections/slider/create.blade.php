...
@section('title', __('main.Slider_Create'))
@section('content')
            ...
            <div class="row align-items-end">
                <div class="col-6">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('main.Add_Slider') }}</h5>
                            <span>{{ __('main.Add_Slider') }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                        ...
                        <div class="card-body">
                            ...
                            @foreach (allLanguages() as $lang)
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger">{{ $errors->first('big_heading') }}</span>
                                </div>
                                <div class="form-group">
