...
@section('title', __('main.Faq_Edit'))
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endforeach
                            <div class="form-group">
                                <label for="">{{ __('main.Faq_Title') }} <span class="text-danger">*</span>
                                </label>
                                <select class="form-control select2" name="type">
                                    <option {{ $faq->type == 1 ? 'selected' : '' }} value="1">
                                        {{ __('main.Basic_Questions') }}</option>
                                    <option {{ $faq->type == 2 ? 'selected' : '' }} value="2">
                                        {{ __('main.Medical_Questions') }}</option>
                                    <option {{ $faq->type == 3 ? 'selected' : '' }} value="3">
                                        {{ __('main.Pricing_Plan') }}</option>
                                    <option {{ $faq->type == 4 ? 'selected' : '' }} value="4">
                                        {{ __('main.Other_Questions') }}</option>
                                </select>
