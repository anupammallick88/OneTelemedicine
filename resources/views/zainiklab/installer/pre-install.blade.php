...
@section('content')
    <div class="section-wrap-body">
        <div class="single-section">
            <h4>{{__('For Version Update to 2.0: ')}}<a href="{{route('update_view')}}" class="btn btn-info text-white rounded">{{__('Click Here')}}</a></h4>
        </div>
        <div class="single-section">
                ...
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td><strong>{{ __('7.3+') }}</strong></td>
                            <td><span class="status {{ phpversion() < 7.3 ? 'error' : '' }}">{{ phpversion() < 7.3 ? __('Error') : __('Ok') }}</span></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="single-section">
            <h4 class="section-title">{{ __('Please make sure you have set  the Writable permission on the following folders/files :') }}</h4>
            <ul class="permission-lsit">
                <li>
                    <span class="permission-text">{{ __('./application/routes') }}</span>
                ...
                <li>
                    <span class="permission-text">{{ __('./application/resources') }}</span>
                ...
                <li>
                    <span class="permission-text">{{ __('./application/public') }}</span>
                ...
                <li>
                    <span class="permission-text">{{ __('./application/storage') }}</span>
                ...
                <li>
                    <span class="permission-text">{{ __('./application/.env') }}</span>
